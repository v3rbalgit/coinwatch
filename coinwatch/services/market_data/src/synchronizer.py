...
from shared.utils.progress import SyncSchedule
...
class BatchSynchronizer:
    ...
    async def schedule_sync(self, symbol: SymbolInfo, timeframe: Timeframe) -> None:
        """
            ...
            try:
                ...
                await self._message_broker.publish(
                    ...
                    ErrorMessage(
                        ...
                        error_type="SyncInfrastructureError",
                        severity="error",
                        message=str(e),
                        context={
                ...
                async with self._sync_semaphore:
                    ...
                    await self._message_broker.publish(
                        MessageType.SYNC_COMPLETE,
                        {
                            ...
                            "exchange": schedule.symbol.exchange,
