...
from ..models.sentiment import TokenSentiment
from ..core.models import SentimentMetrics, SymbolInfo
...
class SentimentRepository:
    ...
    async def upsert_sentiment_metrics(self, metrics: List[SentimentMetrics]) -> None:
        ...
        """
        try:
            async with self.db.get_session(isolation_level=IsolationLevel.REPEATABLE_READ) as session:
